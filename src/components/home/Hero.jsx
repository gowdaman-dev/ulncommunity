...
function Hero() {
    return (
        <div className="w-full min-h-[515px] overflow-hidden flex flex-nowrap md:flex-row flex-col justify-between items-start content-space-between md:py-20 py-10">
